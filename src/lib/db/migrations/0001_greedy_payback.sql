ALTER TABLE `_article_editors` RENAME COLUMN `userId` TO `user_id`;--> statement-breakpoint
/*
...
/*
You're trying to delete PRIMARY KEY(article_id,userId) from '_article_editors' table
...
--> statement-breakpoint
/*
You're trying to add PRIMARY KEY(article_id,user_id) to '_article_editors' table
